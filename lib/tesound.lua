...
function TEsound.playOne(sound, sourceType, tags, volume, pitch, func)
	TEsound.soundsToPlay[sound] = {sourceType = sourceType, tags = tags, volume = volume, pitch = pitch, func = func}
end
...
function TEsound.cleanup()
	for k,v in pairs(TEsound.soundsToPlay) do
		TEsound.play(k,v.sourceType, v.tags, v.volume, v.pitch, v.func)
	end
	TEsound.soundsToPlay = {}
